...
public class GemCraftItem {
    ...
    public static final Supplier<Item> RUBY_CHESTPLATE = register("ruby_chestplate",()-> new ArmorItem(GCArmorMaterial.RUBY,ArmorItem.Type.HELMET,(new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(33)))));
    public static final Supplier<Item> RUBY_LEGGINGS = register("ruby_leggings",()-> new ArmorItem(GCArmorMaterial.RUBY,ArmorItem.Type.HELMET,(new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(33)))));
    ...
    public static final Supplier<Item> SAPPHIRE_HELMET = register("sapphire_helmet",()-> new ArmorItem(GCArmorMaterial.SAPPHIRE,ArmorItem.Type.HELMET,(new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(45)))));
    public static final Supplier<Item> SAPPHIRE_CHESTPLATE = register("sapphire_chestplate",()-> new ArmorItem(GCArmorMaterial.SAPPHIRE,ArmorItem.Type.HELMET,(new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(45)))));
    public static final Supplier<Item> SAPPHIRE_LEGGINGS = register("sapphire_leggings",()-> new ArmorItem(GCArmorMaterial.SAPPHIRE,ArmorItem.Type.HELMET,(new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(45)))));
    public static final Supplier<Item> SAPPHIRE_BOOT = register("sapphire_boots",()-> new ArmorItem(GCArmorMaterial.SAPPHIRE, ArmorItem.Type.BOOTS,(new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(45)))));
